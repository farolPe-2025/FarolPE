      ...
      >
        ...
        <label className="search-field">
          ...
          <input
            ...
            placeholder="Busque por painel, indicador ou página"
          />
          <kbd>ESC</kbd>
        </label>
    ...
    <main className="panel-page">
      <header className="content-header">
        ...
        <div className="content-actions">
          ...
          {panel.embedUrl && (
            <a className="button button-soft" href={panel.embedUrl} target="_blank" rel="noreferrer">
              Abrir em nova aba ↗
            </a>
          )}
        </div>
...
function ComingSoonPage({
  ...
  type: "publicacoes" | "noticias";
  navigate: Navigate;
}) {
  const isPublications = type === "publicacoes";
  return (
    <main className="coming-page">
      <div className="coming-copy">
        <p className="eyebrow dark">{isPublications ? "Publicações" : "Notícias"}</p>
        <h1>
          {isPublications
            ? "Análises para ir além dos números."
            : "O desenvolvimento de Pernambuco em pauta."}
        </h1>
        <p>
          {isPublications
            ? "Este espaço reunirá boletins, notas técnicas e estudos produzidos a partir dos indicadores do Farol PE."
            : "Em breve, acompanhe atualizações, novas bases de dados e os principais movimentos da economia pernambucana."}
        </p>
...
export default function FarolPortal() {
  ...
  else if (pathname === "/publicacoes") content = <ComingSoonPage type="publicacoes" navigate={navigate} />;
  else if (pathname === "/noticias") content = <ComingSoonPage type="noticias" navigate={navigate} />;
